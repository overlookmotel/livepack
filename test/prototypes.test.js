		...
		describe('prototype substituted with', () => {
			...
			describe('Array', () => { // eslint-disable-line jest/lowercase-name
				describe('and', () => {
					it('function has no other props', () => {
						const input = (0, function() {});
						input.prototype = [1, 2, 3];
						run(
							input,
							'Object.assign(function(){},{prototype:[1,2,3]})',
							(fn) => {
								expect(fn).toBeFunction();
					...
					it('function has other props', () => {
						...
						run(
							input,
							'Object.assign(function(){},{prototype:[1,2,3],x:1,y:2})',
							(fn) => {
								expect(fn).toBeFunction();
								expect(fn.prototype).toBeArrayOfSize(3);
								expect(fn.prototype).toEqual([1, 2, 3]);
				...
				describe('with constructor added and', () => {
					it('no [Symbol.toStringTag] property', () => {
						const input = (0, function() {});
						input.prototype = [1, 2, 3];
						input.prototype.constructor = input;
						run(
							input,
							'(()=>{const a=[1,2,3],b=Object.assign(function(){},{prototype:a});a.constructor=b;return b})()',
							(fn) => {
								expect(fn).toBeFunction();
								const {prototype} = fn;
					...
					it('with [Symbol.toStringTag] property', () => {
						const input = (0, function() {});
						input.prototype = [1, 2, 3];
						input.prototype[Symbol.toStringTag] = 'Object';
						input.prototype.constructor = input;
						run(
							input,
							'(()=>{const a=Object.assign,b=a([1,2,3],{[Symbol.toStringTag]:"Object"}),c=a(function(){},{prototype:b});b.constructor=c;return c})()',
							(fn) => {
								expect(fn).toBeFunction();
								const {prototype} = fn;
								expect(prototype).toBeArrayOfSize(3);
					...
					it("with [Symbol.toStringTag] property on prototype's proto", () => {
						const input = (0, function() {});
						const proto = [1, 2, 3];
						proto.constructor = input;
						...
						run(
							input,
							'(()=>{const a=Object,b=a.assign,c=a.setPrototypeOf([1,2,3],b(a.create(Array.prototype),{[Symbol.toStringTag]:"Object"})),d=b(function(){},{prototype:c});c.constructor=d;return d})()',
							(fn) => {
								expect(fn).toBeFunction();
								const {prototype} = fn;
								expect(prototype).toBeArrayOfSize(3);
