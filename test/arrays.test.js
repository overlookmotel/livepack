			...
			describe('without descriptors', () => {
				...
				itSerializesEqual("including prop called '__proto__'", {
					...
					out: `(()=>{
						...
						c(
							b.defineProperty(
								c(a,{x:{value:a,writable:true,enumerable:true,configurable:true}}),
								"__proto__",
			...
			describe('with descriptors', () => {
				...
				itSerializesEqual("including prop called '__proto__'", {
					...
					out: `(()=>{
						...
						c(
							b.defineProperty(
								c(a,{x:{value:a,enumerable:true}}),
								"__proto__",
								{value:a,configurable:true}
							),
	...
	describe('prototype altered', () => {
		describe('to null', () => {
			...
			itSerializesEqual("with extra properties including one named '__proto__'", {
				...
				out: `(()=>{
					...
					return a.setPrototypeOf(
						b(
							a.defineProperty(
								b([1,2,3],{x:{value:4,writable:true,enumerable:true,configurable:true}}),
								"__proto__",
								{value:5,writable:true,enumerable:true,configurable:true}
							),
							{y:{value:6,writable:true,enumerable:true,configurable:true}}
			...
			itSerializesEqual("with extra circular properties including one named '__proto__'", {
				...
				out: `(()=>{
					const a=Object,
						b=a.setPrototypeOf([1,2,3],null),
						c=a.defineProperties;
					c(
						a.defineProperty(
							c(b,{x:{value:b,writable:true,enumerable:true,configurable:true}}),
							"__proto__",
		...
		describe('to Object.prototype', () => {
			...
			itSerializesEqual("with extra circular properties including one named '__proto__'", {
				...
				out: `(()=>{
					const a=Object,
						b=a.setPrototypeOf([1,2,3],a.prototype),
						c=a.defineProperties;
					c(
						a.defineProperty(
							c(b,{x:{value:b,writable:true,enumerable:true,configurable:true}}),
