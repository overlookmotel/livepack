...
function serializeFunction(fn) {
	...
	const {fnId, values, parentScopeId} = res;

	// Record values in scope record
	scopes[parentScopeId].values = values;

	// Get function's AST
	const ast = fns[fnId];

	// TODO
	console.log('function:', {fnId, values, parentScopeId, ast}); // eslint-disable-line no-console
