...
const {createDependency, createAssignment} = require('./records.js'),
	{recordIsCircular, isNumberKey} = require('./utils.js');
...
module.exports = {
	serializeArray(arr, record) {
		...
		// TODO Deal with non-standard descriptors on array elements
		return this.wrapWithProperties(arr, record, node, Array.prototype, undefined, arrayShouldSkipKey);
	}
};
