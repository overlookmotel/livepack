...
// Modules
const {isString, isArray} = require('is-it-type'),
	mapValues = require('lodash/mapValues'),
	t = require('@babel/types'),
	{VISITOR_KEYS, COMMENT_KEYS} = t,
...
const {isJsIdentifier, isNumberKey} = require('./utils.js'),
	{
		isReservedVarName, createArrayOrPush, setAddFrom, getProp, getProps, setProp, isRuntimePath
...
function traverseAll(ast, visit) {
	...
	do {
		...
		for (let i = NUM_COMMENT_KEYS_MINUS_ONE; i >= 0; i--) {
