...
/**
 * Delete last value in array where `fn()` returns truthy value, and return deleted value.
 * @param {Array} arr - Array
 * @param {Function} fn - Function to be called on each item of array
 * @returns {*} - Deleted value
 */
function deleteLast(arr, fn) {
	return deleteIndex(arr, findLastIndex(arr, fn));
}
