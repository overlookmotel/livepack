...
// `import()` does not work correctly in Jest - there are separate Mocha tests to cover this.
// TODO Find way to substitute fallback for Jest only if running tests.
