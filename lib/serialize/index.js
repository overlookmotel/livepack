...
class Serializer {
	constructor() {
		this.records = new Map(); // Keyed by value, contains record objects
		this.scopes = new Map(); // Keyed by scope ID, contains scope objects
		this.functions = new Map(); // Keyed by function ID, contains function values
	}
	...
	serialize(val) {
		...
		console.log('scopes:'); // eslint-disable-line no-console
		console.dir([...this.scopes.values()], {depth: 5}); // eslint-disable-line no-console
