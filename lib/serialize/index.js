...
module.exports = function serialize(val, options) {
	...
	// Get `exec`, `minify`, `inline`, `mangle`, `comments`, `files`, `sourceMaps`, `debug` options.
	...
	for (const optName of [
		'exec', 'minify', 'inline', 'mangle', 'comments', 'files', 'sourceMaps', 'debug'
	]) {
	...
	if (options.inline == null) options.inline = true;
