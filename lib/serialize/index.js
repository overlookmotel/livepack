...
const Serializer = require('./serializer.js'),
	...
	{DEFAULT_STATS_FILENAME, HASH_PLACEHOLDER_CHAR} = require('./constants.js'),
 ...
 * @param {string} [options.entryChunkName='[name]'] - Template for entry chunk names
 * @param {string} [options.splitChunkName='[name].[hash]'] - Template for split chunk names
 * @param {string} [options.commonChunkName='common.[hash]'] - Template for common chunk names
 ...
 *   to this directory
 * @param {boolean|string} [options.stats=null] - Stats file filename (or `true` for default)
...
function conformOptions(options, filesDefault) {
	// TODO: Output new options object to ensure always same shape
...
function conformChunkNameOption(options, name, defaultValue) {
	...
	assert(!value.includes(HASH_PLACEHOLDER_CHAR), `${opt} must not include '${HASH_PLACEHOLDER_CHAR}'`);
