 ...
 *   (default inherits `!options.minify`)
 * @param {boolean} [options.sourceMaps] - If true, output will include inline source maps
...
module.exports = function serialize(val, options) {
	...
	// Get `exec`, `minify`, `inline`, `mangle`, `comments`, `sourceMaps` options.
	...
	for (const optName of ['exec', 'minify', 'inline', 'mangle', 'comments', 'sourceMaps']) {
