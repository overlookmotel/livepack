...
module.exports = {
	...
	wrapWithProperties(val, record, inputNode, defaultProps, shouldSkipKey) {
		return this.serializeProperties(val, record, null, inputNode, defaultProps, shouldSkipKey);
	},

	serializeProperties(val, record, protoRecord, inputNode, defaultProps, shouldSkipKey) {
	...
	serializeProperty(
		...
		const modifiers = createModifiers(
			...
			defaultProp || (isCircular ? DEFAULT_MODIFIERS : DEFAULT_DESCRIPTOR_MODIFIERS)
		);
