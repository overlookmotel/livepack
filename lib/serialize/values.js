...
const {serializePrimitive} = require('./primitives.js'),
	...
	{GLOBAL, MODULE, VALUE, GETTER, SETTER, PROTO} = require('../shared/constants.js'),
...
module.exports = {
	...
	serializeGlobal(val, {parent, type, key}) {
		...
		if (type === VALUE) {
			...
			throw new Error(`Unexpected global: '${key}' type ${type} - ${val}`);
		}
