...
module.exports = {
	...
	traceValueInner(val, name) {
		...
		if (type !== 'object' && type !== 'function' && type !== 'symbol' && type !== 'undefined') {
	...
	traceGlobal(val, globalProps) { // eslint-disable-line no-unused-vars
		// TODO
		throw new Error('Globals not supported');
	},
	...
	serializeValue(record) {
		return record.serializer(record, this);
	},
