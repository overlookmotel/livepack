...
const {
	useInternalModuleCache, usingInternalModuleCache, exposeModule, exposeModules
...
const sourceMapSupportPath = Module.createRequire(require.resolve('@babel/register'))
	.resolve('source-map-support');
exposeModule(sourceMapSupportPath);

// Constants
const EXTS = babel.DEFAULT_EXTENSIONS,
