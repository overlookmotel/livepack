...
function functionExitVisitor(fnPath, state) {
	...
	// `/*livepack_track:{"id":3,"scopes":[{"blockId":1,"varNames":["a"]}, {"blockId":2,"varNames":["b", "arguments"],argNames:["b"]}],"filename":"/path/to/file.js","isMethod":true}*/`
...
function identifierVisitor(identifierPath, state) {
	...
	if (bindingPath.isFunctionDeclaration()) {
		...
		if (bindingParentPath.isFunction()) {
			...
			assertWithLocation(
				bindingPath.isIdentifier() || bindingPath.isObjectPattern(), bindingPath, state,
