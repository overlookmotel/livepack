...
const Statement = require('./statement.js'),
	{
		ImportDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportAllDeclaration
	} = require('./module.js'),
...
function TopLevelStatement(node, state, parent, key) {
	...
	(topLevelStatementVisitors[node.type] || Statement)(node, state, parent, key);
}

const topLevelStatementVisitors = {
	ImportDeclaration,
