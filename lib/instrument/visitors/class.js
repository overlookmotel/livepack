...
function ClassDeclaration(node, state, parent, key) {
	...
	createBindingWithoutNameCheck(state.currentBlock, className, {isFrozenName: true});
...
function visitClass(classNode, parent, key, className, state) {
	...
	// TODO: Are these needed if no constructor?
...
function instrumentClass(
	...
	if (superVarNode) {
		...
		// TODO: Does inserting into body array mess up re-inserting functions in computed method keys?
