...
const {argv} = yargs
	...
	.option('skip-babel-cache-for-dir', {
		description: 'Disable Babel cache for files in directory',
		type: 'string'
	})
	.option('debug', {
...
register({
	...
	skipCacheForDir: argv.skipBabelCacheForDir ? pathResolve(argv.skipBabelCacheForDir) : undefined
});
