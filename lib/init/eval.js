...
const visitor = require('../babel/visitor.js'),
	...
	{
		EVAL, INTERNAL_VAR_NAMES_PREFIX, TRACKER_VAR_NAME_BODY,
		EVAL_VAR_NAME_BODY, PREVAL_VAR_NAME_BODY, GET_EVAL_VAR_NAME_BODY
	} = require('../shared/constants.js'),
	{globals} = require('../internal.js'),
...
function preval(code, args, filename, prefixNum) {
	...
	// `{x: {blockId: 1, scopeId: 1, blockName: 'index', argNames: undefined}, y: ..., z: ...}`
	const scopeVars = Object.create(null);
	const scopes = last(args);
	for (const [blockId, scopeId, blockName, varNames, argNames] of scopes) {
