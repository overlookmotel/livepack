...
const visitor = require('../babel/visitor.js'),
	{
		BLOCK_ID, PARENT_VARS, INTERNAL_VAR_PREFIX_NUM, EVAL_IS_USED, IS_EVAL_CODE, IS_COMMON_JS
...
function getEvalFunctions(filename, prefixNum) {
	...
	const prevalLocal = (code, scopes) => preval(code, scopes, filename, prefixNum);
...
function preval(code, scopes, filename, prefixNum) {
