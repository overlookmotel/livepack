 ...
 *
 * @returns {WeakMap|undefined} - `WeakMap` of all `WeakSet`s
 *   (or `undefined` if not supported on this version of NodeJS).
 ...
 *
 * @returns {WeakMap|undefined} - `WeakMap` of all `WeakMap`s
 *   (or `undefined` if not supported on this version of NodeJS).
