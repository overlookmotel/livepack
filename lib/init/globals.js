...
const {isPrimitive} = require('../shared/functions.js'),
	...
	{getCallSite} = require('../serialize/external.js');
 ...
 *
 * @returns {Map} - Map of globals, keyed by value
 */
...
function preloadGetter(get, parent, key, descriptor, nextLevelQueue, globals) {
	// Shim getter to catalog value lazily when getter is eexecuted
