...
module.exports = {
	...
	IMPORT_VAR_NODE: Symbol('livepack.IMPORT_VAR_NODE'),
	IMPORT_ASYNC_VAR_NODE: Symbol('livepack.IMPORT_ASYNC_VAR_NODE'),
	EXPORTS_VAR_NODE: Symbol('livepack.EXPORTS_VAR_NODE'),
	GLOBAL_VAR_NODE: Symbol('livepack.GLOBAL_VAR_NODE'),
	MODULE_VARS: Symbol('livepack.MODULE_VARS'),
