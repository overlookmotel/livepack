 ...
 * @param {Object} blockNode - AST node for statement block
 * @returns {boolean} - `true` if block contains a 'use strict' directive
 */
function containsUseStrictDirective(blockNode) {
	return blockNode.directives.some(directiveNode => directiveNode.value.value === 'use strict');
}

/**
 * Create AST node for `void 0`.
