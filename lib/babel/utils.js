 ...
 * @param {boolean} superIsProto - `true` if var is `super` and refers to class prototype
 * @param {Object} state - State object
 * @returns {Array<Object>} - Array of scope objects
 */
function recordVarUse(name, functionPath, bindingBlockPath, isConst, superVarNode, superIsProto, state) {
 ...
 */
function createTrackerComment(id, scopes, isStrict, isMethod, superIsProto, state) {
