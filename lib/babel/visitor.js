...
function getBindingLocation(bindingPath, identifierPath, name, state) {
	...
	// In sloppy mode only, function declarations can be prefixed with a label e.g. `a: function x() {}`.
	// This needs no special handling, as will skip over the labels as sloppy mode functions
	// are bound to block of function above.
