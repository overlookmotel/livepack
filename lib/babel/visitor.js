...
function functionExitVisitor(fnPath, state) {
	...
	// - Class constructors: At start of class body
	// - Methods with computed key: Before key
	// (last is for if key contains another function, so outer function's tracker comment comes first)
	...
	if (isCtor) {
		commentHolderPath = fnPath.parentPath;
		commentHolderPath.parentPath[HAS_CONSTRUCTOR] = true;
