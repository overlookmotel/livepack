...
const {
		...
		createTempVarNode, tagTempVarWithType, getUnusedNum, internalIdentifier, assertWithLocation
	} = require('./utils.js'),
	{
		INIT_PATH, TRACKER_VAR_NAME, SCOPE_ID_VAR_NAME, TEMP_VAR_NAME, TOP_BLOCK_ID, COMMON_JS_VARS
	} = require('./constants.js'),
	{
		TRACKER_VAR_NUMS_USED, TRACKER_VAR_NODE,
		SCOPE_ID_VAR_NUMS_USED, SCOPE_ID_VAR_NODES, SCOPE_ID_VAR_NODE,
		TEMP_VAR_NUMS_USED, TEMP_VAR_NODES,
		BLOCK_ID,
