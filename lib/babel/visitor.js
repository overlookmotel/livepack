	...
	if (t.isClass(fnNode)) {
		...
		if (constructorIndex !== -1) {
			...
			const bodyNode = constructorNode.body,
				directiveNodes = amendDirectives(bodyNode, true);
			if (directiveNodes) {
				constructorNode = {...constructorNode, body: {...bodyNode, directives: directiveNodes}};
		...
		if (t.isBlockStatement(bodyNode)) {
			...
			if (directiveNodes) fnNode = {...fnNode, body: {...bodyNode, directives: directiveNodes}};
		}
	}
