...
// Imports
const {classEnterVisitor, classBodyExitVisitor, classExitVisitor} = require('./classes.js'),
	{
		functionDeclarationEnterVisitor, functionExpressionEnterVisitor,
		arrowFunctionEnterVisitor, methodEnterVisitor, exitMethodKey,
	...
	{catchClauseEnterVisitor, catchClauseExitVisitor} = require('./catch.js'),
	...
	{switchStatementEnterVisitor, switchStatementExitVisitor} = require('./switch.js'),
...
module.exports = function(programPath, babelState, evalState) {
	...
	programPath.traverse({
		...
		SwitchStatement: {
			enter: path => switchStatementEnterVisitor(path, state),
			exit: path => switchStatementExitVisitor(path, state)
		},
