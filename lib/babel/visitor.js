...
function getBindingLocation(bindingPath, name, state) {
	// Function/class declarations are bound to parent statement block except sloppy-mode function
	// declarations which are scoped to enclosing function body.
	const isFunctionDeclaration = bindingPath.isFunctionDeclaration();
	if (isFunctionDeclaration && !bindingPath[PARENT_IS_STRICT]) {
	...
	if (isFunctionDeclaration || bindingPath.isClassDeclaration()) {
