...
const {createBlockId} = require('./utils.js'),
	{
		...
		AST_VAR_NAME_BODY, EVAL_VAR_NAME_BODY, PREVAL_VAR_NAME_BODY, GET_EVAL_VAR_NAME_BODY
...
const TRACKER_VAR_NAME = `${INTERNAL_VAR_NAMES_PREFIX}_${TRACKER_VAR_NAME_BODY}`,
	...
	AST_VAR_NAME = `${INTERNAL_VAR_NAMES_PREFIX}_${AST_VAR_NAME_BODY}_`,
...
function createAstVarNode(id, state) {
	return createInternalVarNode(`${AST_VAR_NAME}${id}`, state);
}
