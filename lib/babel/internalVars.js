...
// Imports
const {createBlockId} = require('./utils.js'),
	{internalIdentifier} = require('../shared/functions.js'),
	{
		INTERNAL_VAR_NAMES_PREFIX,
		TRACKER_VAR_NAME_BODY, GET_SCOPE_ID_VAR_NAME_BODY, SCOPE_ID_VAR_NAME_BODY,
		ESM_VAR_NAME_BODY, TEMP_VAR_NAME_BODY,
...
const TRACKER_VAR_NAME = `${INTERNAL_VAR_NAMES_PREFIX}_${TRACKER_VAR_NAME_BODY}`,
	...
	ESM_VAR_NAME = `${INTERNAL_VAR_NAMES_PREFIX}_${ESM_VAR_NAME_BODY}`,
...
function createEsmVarNode(state) {
	return createInternalVarNode(ESM_VAR_NAME, state);
}
