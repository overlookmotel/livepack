...
// TODO Handle where vars with same names in init clause + body:
// ```js
// const fns = [];
// for (const [x, getOuterX = () => x] of y) {
//   const x = getOuterX() + 100;
//   const getInnerX = () => x;
//   fns.push( { getOuterX, getInnerX } );
// }
// ```
// Babel's `scope.getBinding()` will return wrong binding.
